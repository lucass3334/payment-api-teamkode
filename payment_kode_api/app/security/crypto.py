...
import base64
from ..database.database import get_empresas_certificados  # 🔹 Alterado para o nome correto


def get_private_key(empresa_id: str):
    """Busca a chave privada RSA da empresa no banco de dados."""
    certificados = get_empresas_certificados(empresa_id)  # 🔹 Atualizado o nome da função
